...
- **Tier 2 (비주얼)**: ✅ 카메라 댐핑 · ✅ hemisphere ambient(warm/cool) · vegetation alpha card(풀 clump, alpha test, 거리/밀도 제한) · height fog · organic dressing layer(잔돌/흙 패치) · vegetation/object variation · wind · **AA(SMAA + FXAA fallback)** · LUT
