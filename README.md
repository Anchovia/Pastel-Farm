...
- Settings 1차 App-state — MainMenu에서 `S`로 Settings 화면 진입, `ESC`로 MainMenu 복귀. 실제 설정값 변경은 추후
...
- **Tier 1**: ✅ DevUI(ImGui) + GPU 프로파일링 · ✅ `FrameRenderData` 스냅샷 · ✅ `GpuBuffer` RAII · App-state(✅ MainMenu 1차 · ✅ Settings 1차 · ✅ Loading 1차 · ✅ Pause 1차 / 실제 옵션 적용 예정)
